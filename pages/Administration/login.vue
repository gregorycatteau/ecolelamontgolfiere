<template>
  <main>
    ...
    >
      ...
      >
        <h2 class="mb-5 text-lg font-medium text-[#aac8e4]">Accéder</h2>
        <div class="relative mb-4">
          <label for="full-name" class="text-sm leading-7 text-gray-400">adresse mail</label>
          <input
            v-model="email"
            type="email"
            id="email"
        ...
        <div class="relative mb-4">
          <label for="password" class="text-sm leading-7 text-gray-400">Mot de passe</label>
          <input
            id="password"
            v-model="password"
            name="password"
        ...
        <span
          ...
          >{{ errorMsg }}</span
        >
        <p class="mt-3 text-xs">Vous n'avez pas encore de compte ?</p>
        <nuxt-link class="w-fit text-sm text-[#aac8e4] hover:text-[#42b883]" to="/Administration/register"
          >S'enregistrer</nuxt-link
        >
      </form>
    </section>
  </main>
