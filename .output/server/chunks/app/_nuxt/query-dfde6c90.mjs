...
import { d as useNuxtApp, c as createError, b as useRuntimeConfig, e as useRequestEvent } from '../server.mjs';
import { withLeadingSlash, joinURL, withoutTrailingSlash } from 'ufo';
import { isEqual, hash } from 'ohash';
import { parse, serialize } from 'cookie-es';
import { appendHeader } from 'h3';
import destr from 'destr';
import { w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils-a31a5083.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-1a1fb2d6.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-dfde6c90.mjs.map
