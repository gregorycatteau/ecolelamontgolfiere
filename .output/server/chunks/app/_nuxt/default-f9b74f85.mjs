...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({
    class: { dark: $setup.isDark }
  }, _attrs))} data-v-32e8a67d><nav class="nav" data-v-32e8a67d><ul class="ul" data-v-32e8a67d><li class="li" data-v-32e8a67d>`);
  ...
  _push(`</li><li class="li" data-v-32e8a67d>`);
...
const Footing = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-32e8a67d"]]);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><nav class="nav"><ul class="ul"><li class="li">`);
      _push(ssrRenderComponent(_component_nuxt_link, {
        to: "/ecole",
        class: "link"
      }, {
      ...
      _push(`</li></ul><button class="toggle-btn"><span class="toggle-indicator"></span></button>`);
      if (unref(isDark)) {
...
//# sourceMappingURL=default-f9b74f85.mjs.map
