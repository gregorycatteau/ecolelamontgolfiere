import { getCurrentInstance, version, toRef, isRef, inject, ref, defineComponent, h, computed, watchEffect, watch, provide, reactive, isReactive, toRaw, useSSRContext, createApp, markRaw, effectScope, unref, getCurrentScope, onScopeDispose, nextTick, onErrorCaptured, onServerPrefetch, toRefs, shallowRef, isReadonly, defineAsyncComponent, createTextVNode, resolveComponent, withCtx, createVNode, triggerRef, Suspense, Transition } from 'vue';
...
import { hasProtocol, parseURL, joinURL, encodeParam, isEqual as isEqual$1, withLeadingSlash, encodePath } from 'ufo';
import { parse, serialize } from 'cookie-es';
import { isEqual } from 'ohash';
import { createClient } from '@supabase/supabase-js';
import { defu } from 'defu';
import { error, createNode, createMessage, warn, getNode, watchRegistry, isNode, resetCount, sugar, isDOM, isComponent, isConditional, compile, createConfig, clearErrors, setErrors, submitForm, reset, createClasses, generateClassList } from '@formkit/core';
import { cloneAny, extend, camel, kebab, nodeProps, only, except, undefine, slugify, isObject, isPojo, token, has, empty, eq, shallowClone } from '@formkit/utils';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/Actualites-5141d9c9.mjs').then((m) => m.default || m)
  },
  {
    name: "slug",
    path: "/:slug(.*)*",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_...slug_-8baa7aea.mjs').then((m) => m.default || m)
  },
  {
    name: "contact",
    path: "/contact",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/contact-d8850820.mjs').then((m) => m.default || m)
  },
  {
    name: "ecole",
    path: "/ecole",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/ecole-1d317091.mjs').then((m) => m.default || m)
  },
  {
    name: "equipe",
    path: "/equipe",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/equipe-337d34bd.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-d2b6d85a.mjs').then((m) => m.default || m)
  },
  {
    name: "inscription",
    path: "/inscription",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/inscription-71502605.mjs').then((m) => m.default || m)
  },
  {
    name: "lamontgolfiere",
    path: "/lamontgolfiere",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/lamontgolfiere-0698f2d6.mjs').then((m) => m.default || m)
  },
  {
    name: "legal-notice",
    path: "/legal-notice",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/legal-notice-93a94dfc.mjs').then((m) => m.default || m)
  },
  {
    name: "rejoindre",
    path: "/rejoindre",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/rejoindre-794cf31e.mjs').then((m) => m.default || m)
  },
  {
    name: "ressources",
    path: "/ressources",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/ressources-6cc09a9a.mjs').then((m) => m.default || m)
  },
  {
    name: "tarifs",
    path: "/tarifs",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/tarifs-e27f2999.mjs').then((m) => m.default || m)
  }
];
...
const useSupabaseAuthClient = () => {
  ...
  if (!nuxtApp._supabaseAuthClient) {
    const token2 = useSupabaseToken();
    const authorizationHeader = token2.value ? `Bearer ${token2.value}` : void 0;
...
const supabase_server_6VOknHCOlQ = /* @__PURE__ */ defineNuxtPlugin(async () => {
  ...
  const { data: { user: supabaseUser }, error: error2 } = ([__temp, __restore] = executeAsync(() => authClient.auth.getUser(token2.value)), __temp = await __temp, __restore(), __temp);
  if (error2) {
    token2.value = null;
    user.value = null;
...
const ipxRuntime$gl3iMsYCc4 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  getImage,
  supportsAlias,
  validateDomains
...
imageOptions.providers = {
  ["ipx"]: { provider: ipxRuntime$gl3iMsYCc4, defaults: {} }
};
...
const layouts = {
  default: () => import('./_nuxt/default-b8f905e5.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-082c2d27.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-45682fd0.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { FormKit as F, _export_sfc as _, useHead as a, useRuntimeConfig as b, createError as c, useNuxtApp as d, entry$1 as default, useCookie as e, useRequestEvent as f, useState as g, useRouter as h, useSupabaseToken as i, defineStore as j, navigateTo as n, useRoute as u };
