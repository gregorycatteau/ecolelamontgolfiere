...
import { u as useAsyncData, q as queryContent, e as encodeQueryParams, j as jsonStringify } from './query-4df98926.mjs';
import { g as useState, b as useRuntimeConfig, e as useCookie } from '../server.mjs';
import { hash } from 'ohash';
import { _ as __nuxt_component_0 } from './nuxt-link-d23e8ff6.mjs';
import { u as useContentDisabled, w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils-b462b102.mjs';
import 'ufo';
import 'ofetch';
import 'hookable';
import 'unctx';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-7ed62a54.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-9e1a9f47.mjs.map
