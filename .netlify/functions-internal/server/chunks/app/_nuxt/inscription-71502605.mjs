...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="wrapper" data-v-c290d98e><div class="subwrapper" data-v-c290d98e><h1 class="title" data-v-c290d98e>Notre processus d&#39;inscription</h1><p class="text" data-v-c290d98e>Avant d\u2019entamer un processus d&#39;admission, nous vous encourageons \xE0 en apprendre autant que possible sur <span data-v-c290d98e>`);
      _push(ssrRenderComponent(_component_nuxt_link, {
        to: "/projetpedagogique2",
        class: "link"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`notre p\xE9dagogie`);
          } else {
            return [
              createTextVNode("notre p\xE9dagogie")
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</span> et notre philosophie.</p><p class="text" data-v-c290d98e>Vous pouvez consulter notre site internet, nous rencontrer lors d\u2019une r\xE9union d\u2019information ou d\u2019une visite de l\u2019\xE9cole, ou encore nous contacter par t\xE9l\xE9phone ou par mail.</p><p class="text" data-v-c290d98e>Nous vous invitons \xE9galement \xE0 regarder ces multiples ressources \xE0 lire et \xE0 visionner pour nourrir votre r\xE9flexion.</p></div><div class="subwrapper" data-v-c290d98e><h2 class="soustitre" data-v-c290d98e>Crit\xE8res d&#39;admission</h2>`);
      _push(ssrRenderComponent(_component_P, { class: "text" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`L\u2019\xE9cole accueille des enfants et adolescents de 2 \xE0 16 ans. Ils peuvent int\xE9grer l\u2019\xE9cole \xE0 tout moment de l\u2019ann\xE9e, \xE0 condition qu&#39;il reste de la place.`);
          } else {
            return [
              createTextVNode("L\u2019\xE9cole accueille des enfants et adolescents de 2 \xE0 16 ans. Ils peuvent int\xE9grer l\u2019\xE9cole \xE0 tout moment de l\u2019ann\xE9e, \xE0 condition qu'il reste de la place.")
            ];
          }
        }),
        _: 1
      ...
      _push(`</div><div class="subwrapper" data-v-c290d98e><h2 class="soustitre" data-v-c290d98e>Frais de scolarit\xE9</h2>`);
      _push(ssrRenderComponent(_component_P, { class: "text" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Toutes les informations sur les frais de scolarit\xE9 sont sur <span data-v-c290d98e${_scopeId}>`);
      ...
      _push(`</div><div class="subwrapper" data-v-c290d98e><h2 class="soustitre" data-v-c290d98e>Etapes d&#39;inscription</h2><ol class="wrapperlist" data-v-c290d98e><li class="itemlist" data-v-c290d98e>Prendre contact :</li><p class="text" data-v-c290d98e>Remplissez le formulaire ci-dessous, nous vous recontacterons par mail ou t\xE9l\xE9phone pour convenir d\u2019un premier \xE9change t\xE9l\xE9phonique. Vous pourrez \xE9galement nous faire part de votre besoin d\u2019une bourse lors de ce premier \xE9change.</p><li class="itemlist" data-v-c290d98e>Se rencontrer : </li>`);
      _push(ssrRenderComponent(_component_P, { class: "text" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(`<li class="itemlist" data-v-c290d98e>Se d\xE9cider</li>`);
      _push(ssrRenderComponent(_component_P, { class: "text" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(`<li class="itemlist" data-v-c290d98e>S&#39;adapter</li>`);
      _push(ssrRenderComponent(_component_P, { class: "text" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(`<li class="text" data-v-c290d98e>Valider l&#39;int\xE9gration :</li>`);
      _push(ssrRenderComponent(_component_P, { class: "text" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(`<div class="separator" data-v-c290d98e></div><h1 class="title" data-v-c290d98e>Formulaire d&#39;inscription</h1></div><div class="form" data-v-c290d98e>`);
      _push(ssrRenderComponent(unref(FormKit), {
        ...
        default: withCtx(({ state }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<button class="bouton" data-v-c290d98e${_scopeId}> soumettre</button>`);
          } else {
            return [
              ...
              createVNode("button", { class: "bouton" }, " soumettre")
            ];
          }
        }),
        _: 1
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-c290d98e"]]);
const _sfc_main = {
  name: "inscription"
};
const _imports_0 = "" + buildAssetsURL("slider3.2d5a102c.jpg");
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_Subscribe = __nuxt_component_0;
  _push(`<!--[--><div class="wrapper" data-v-4675caf9></div><img${ssrRenderAttr("src", _imports_0)} alt="notfound" class="imagefond" height="400" data-v-4675caf9><div class="postitle" data-v-4675caf9><div class="overlay" data-v-4675caf9><h1 class="title" data-v-4675caf9>Merci de votre int\xE9r\xEAt pour l&#39;\xE9cole La Montgolfi\xE8re</h1><p class="subtitle" data-v-4675caf9>L&#39;\xE9cole o\xF9 nous \xE9levons ensemble</p></div></div>`);
...
const inscription = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-4675caf9"]]);

export { inscription as default };
//# sourceMappingURL=inscription-71502605.mjs.map
