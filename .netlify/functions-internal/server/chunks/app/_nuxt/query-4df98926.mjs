...
import { d as useNuxtApp, c as createError, b as useRuntimeConfig, e as useCookie } from '../server.mjs';
import { withLeadingSlash, joinURL, withoutTrailingSlash } from 'ufo';
import { hash } from 'ohash';
import { w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils-b462b102.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-7ed62a54.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-4df98926.mjs.map
