...
import { withoutBase, joinURL, parseURL, withQuery, withLeadingSlash, withoutTrailingSlash, isRelative } from 'ufo';
import { eventHandler, setHeaders, sendRedirect, proxyRequest, defineEventHandler, handleCacheHeaders, createEvent, getRequestHeader, setResponseStatus, setResponseHeader, getRequestHeaders, lazyEventHandler, assertMethod, readBody, setCookie, getQuery, getCookie, createError, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent } from 'h3';
...
const _runtimeConfig = {"app":{"baseURL":"/","buildAssetsDir":"/_nuxt/","cdnURL":""},"nitro":{"envPrefix":"NUXT_","routeRules":{"/__nuxt_error":{"cache":false},"/_nuxt/**":{"headers":{"cache-control":"public, max-age=31536000, immutable"}}}},"public":{"content":{"locales":[],"defaultLocale":"","integrity":1684574680185,"experimental":{"stripQueryParameters":false,"clientDB":false},"api":{"baseURL":"/api/_content"},"navigation":{"fields":[]},"tags":{"p":"prose-p","a":"prose-a","blockquote":"prose-blockquote","code-inline":"prose-code-inline","code":"prose-code","em":"prose-em","h1":"prose-h1","h2":"prose-h2","h3":"prose-h3","h4":"prose-h4","h5":"prose-h5","h6":"prose-h6","hr":"prose-hr","img":"prose-img","ul":"prose-ul","ol":"prose-ol","li":"prose-li","strong":"prose-strong","table":"prose-table","thead":"prose-thead","tbody":"prose-tbody","td":"prose-td","th":"prose-th","tr":"prose-tr"},"highlight":false,"wsUrl":"","documentDriven":false,"host":"","trailingSlash":false,"anchorLinks":{"depth":4,"exclude":[1]}},"supabase":{"url":"https://kdniezwsxmxvizkboxjc.supabase.co","key":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImtkbmllendzeG14dml6a2JveGpjIiwicm9sZSI6ImFub24iLCJpYXQiOjE2ODA3OTQxOTYsImV4cCI6MTk5NjM3MDE5Nn0.PavDGQL_IW_n8C3lWXQdoGTKZVk2O2471_FxN8x22lI","client":{},"redirect":false,"cookies":{"name":"sb","lifetime":28800,"domain":"","path":"/","sameSite":"lax"}}},"content":{"cacheVersion":2,"cacheIntegrity":"kc4UzpZUjI","transformers":[],"base":"","api":{"baseURL":"/api/_content"},"watch":{"ws":{"port":{"port":4000,"portRange":[4000,4040]},"hostname":"localhost","showURL":false}},"sources":{},"ignores":["\\.","-"],"locales":[],"defaultLocale":"","highlight":false,"markdown":{"tags":{"p":"prose-p","a":"prose-a","blockquote":"prose-blockquote","code-inline":"prose-code-inline","code":"prose-code","em":"prose-em","h1":"prose-h1","h2":"prose-h2","h3":"prose-h3","h4":"prose-h4","h5":"prose-h5","h6":"prose-h6","hr":"prose-hr","img":"prose-img","ul":"prose-ul","ol":"prose-ol","li":"prose-li","strong":"prose-strong","table":"prose-table","thead":"prose-thead","tbody":"prose-tbody","td":"prose-td","th":"prose-th","tr":"prose-tr"},"anchorLinks":{"depth":4,"exclude":[1]},"remarkPlugins":{},"rehypePlugins":{}},"yaml":{},"csv":{"delimeter":",","json":true},"navigation":{"fields":[]},"documentDriven":false,"experimental":{"clientDB":false,"stripQueryParameters":false}},"supabase":{"serviceKey":""},"ipx":{"dir":"../../../dist","domains":[],"sharp":{},"alias":{}}};
...
const _assets = {
  ["nitro:bundled:cache:content:content-index.json"]: {
    ...
    meta: {"type":"application/json","etag":"\"143-uSttErrkggJpCsCp/0HLhfthMvw\"","mtime":"2023-05-20T09:25:32.515Z"}
  },
  ["nitro:bundled:cache:content:content-navigation.json"]: {
    import: () => import('../raw/content-navigation.mjs').then(r => r.default || r),
    meta: {"type":"application/json","etag":"\"162-Bn0wo6/hG2Q3nzo6Wp6eCr9PMCI\"","mtime":"2023-05-20T09:25:32.515Z"}
  },
  ["nitro:bundled:cache:content:parsed:content:mentions-legales.md"]: {
    import: () => import('../raw/mentions-legales.mjs').then(r => r.default || r),
    meta: {"type":"text/markdown; charset=utf-8","etag":"\"bb85-bxvjDmYj+wriBI5HzfK8H0gfVO0\"","mtime":"2023-05-20T09:25:32.519Z"}
  },
  ["nitro:bundled:cache:content:parsed:content:peda.md"]: {
    import: () => import('../raw/peda.mjs').then(r => r.default || r),
    meta: {"type":"text/markdown; charset=utf-8","etag":"\"28d-hnG6DzjQh+7W5EOPjNdLChGuG3A\"","mtime":"2023-05-20T09:25:32.515Z"}
  },
  ["nitro:bundled:cache:content:parsed:content:projetpedagogique.md"]: {
    ...
    meta: {"type":"text/markdown; charset=utf-8","etag":"\"873d-Z2F1C8EKDURQIax3mytoyFWO5tw\"","mtime":"2023-05-20T09:25:32.519Z"}
  },
  ["nitro:bundled:cache:content:parsed:content:projetpedagogique2.md"]: {
    ...
    meta: {"type":"text/markdown; charset=utf-8","etag":"\"7fc5-1Cnm+EbTljCF6HxJLVZP9P+sdiM\"","mtime":"2023-05-20T09:25:32.519Z"}
  },
  ["nitro:bundled:cache:content:parsed:content:statuts asso lamontgolfiere.md"]: {
    import: () => import('../raw/statuts asso lamontgolfiere.mjs').then(r => r.default || r),
    meta: {"type":"text/markdown; charset=utf-8","etag":"\"81e1-8IT8FnI19LwYXI9X/eshmhuEppo\"","mtime":"2023-05-20T09:25:32.519Z"}
  },
  ["nitro:bundled:cache:content:parsed:content:statuts_associatifs.md"]: {
    ...
    meta: {"type":"text/markdown; charset=utf-8","etag":"\"6a66-2VWp2ES0BSh8DgIiNqPKQRS7+Tk\"","mtime":"2023-05-20T09:25:32.515Z"}
  }
};
...
const _siIOvh = defineEventHandler(async (event) => {
...
const _lazy_VjR2w0 = () => import('../handlers/renderer.mjs').then(function (n) { return n.r; });
...
const handlers = [
  ...
  { route: '/api/_supabase/session', handler: _siIOvh, lazy: false, middleware: false, method: undefined },
  ...
  { route: '/api/_content/cache.1684574680185.json', handler: _qjvN03, lazy: false, middleware: false, method: "get" },
