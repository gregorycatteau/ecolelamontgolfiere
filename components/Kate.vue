<template>
    ...
    <div class="columns">
      <div class="column1">
        <h2 class="jenny">Relations, Partenariats, etc</h2>
        ...
        <div class="mainskillwrapper">
          <div class="skillwrapper">
            <div class="wrapperdef">
              ...
              <h2 class="profession">Psychologue, psychothérapeute</h2>
            </div>
            <div class="wrapperdef">
              ...
              <h2 class="profession">Développement, partenariats</h2>
            </div>
          </div>
...
.column1 {
  @apply  md:m-auto md:w-10/12 bg-pastel-charte-bleu rounded-3xl shadow-lg;
}
.jenny {
